'''
This code is borrowed from the PointNet2 Jittor implementation.
https://github.com/jittor-online-first/pointnet2-jittor/blob/master/pointnet_ops.py
'''
import math
import jittor as jt
...
class FurthestPointSampler(nn.Module):
    ...
    def execute(self, x, return_index=False):
        '''
        Parameters
        ----------
        x: jt.Var, (B, N, 3)S
