...
# 使用基于normals的优化内部约束训练骨骼预测模型

echo "开始使用基于normals的优化内部约束训练骨骼预测模型..."

# 基础配置
DATA_ROOT="data"
TRAIN_LIST="data/train_list.txt"
VAL_LIST="data/val_list.txt"
OUTPUT_DIR="output/skeleton_normals_interior"
BATCH_SIZE=8
EPOCHS=100
...
echo ""
echo "基于normals的内部约束优势："
echo "1. 直接使用数据集中已有的法向量信息"
echo "2. 更精确的内外部判断"
echo "3. 更好的计算效率"
echo "4. 更稳定的梯度"
echo ""
...
echo ""
echo "使用以下命令测试normals内部约束的优势:"
echo "python test_normal_based_interior_loss.py"
echo "python demo_normals_interior_advantage.py"
